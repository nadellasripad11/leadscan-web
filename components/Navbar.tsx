    ...
    <nav className={`glass-nav${scrolled ? " scrolled" : ""}`} style={{ position: "sticky", top: 0, zIndex: 50 }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 28px", height: 62, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 30 }}>
          <Link href="/examples" className={`nav-link${active === "examples" ? " active" : ""}`}>Examples</Link>
          <Link href="/docs"     className={`nav-link${active === "docs"     ? " active" : ""}`}>Docs</Link>
          <a href="https://github.com/nadellasripad11/leadscan" target="_blank" rel="noopener noreferrer"
            className="nav-link"
